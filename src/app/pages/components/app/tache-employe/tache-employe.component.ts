...
@Component({
  selector: 'app-tache-employe',
  templateUrl: './tache-employe.component.html',
  styleUrls: ['./tache-employe.component.scss'],
...
export class TacheEmployeComponent implements OnInit {
    ...
    finByprojetLibelle(libelle: string) {
        this.service.get('/tache/libelle/' + libelle+'/employe/'+localStorage.getItem("user")).subscribe(
            data => {
                this.taches = data;
            }
        )
